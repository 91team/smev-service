...
//            File("/Users/danil/projects/smev/files/test.doc")
//        )
...
//                "</ns:SendLetterRequest>"
        ...
        val sendReq = SenderProvidedRequestData().apply {
            ...
            attachmentHeaderList = setMTOMFiles(sign, files).takeIf { files.isNotEmpty() }
        }
        ...
        val reqParam = SendRequestRequest().apply {
            ...
            attachmentContentList = buildAttachments(files).takeIf { files.isNotEmpty() }
    ...
    fun setMTOMFiles(signer: Signer, files: List<File>): AttachmentHeaderList {
